...
def main():
    ...
    joblib.dump(
        ...
        "results/models/baseline_logreg.joblib"
    )
    ...
    preds_df.to_csv("results/predictions/baseline_test_preds.csv", index=False)

    with open("results/metrics/baseline_ml_metrics.json", "w") as f:
        json.dump(metrics, f, indent=2)

    print("Phase 2 complete.")
    print("Saved model: results/models/baseline_logreg.joblib")
    print("Saved predictions: results/predictions/baseline_test_preds.csv")
    print("Saved metrics: results/metrics/baseline_ml_metrics.json")
